    ...
    return (
        <form onSubmit={handleCreateToken} className="space-y-6">
            ...
            <div className="space-y-2 sm:space-y-3 pt-3 sm:pt-4 border-t border-white/10">
                ...
                <input type="url" name="website" value={formData.website} onChange={handleInputChange} placeholder="https://yourproject.com" className="w-full bg-dark-700 border border-white/10 rounded-lg sm:rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-white text-xs sm:text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-sol-cyan/50" />
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <input type="url" name="twitter" value={formData.twitter} onChange={handleInputChange} placeholder="https://x.com/yourhandle" className="bg-dark-700 border border-white/10 rounded-lg sm:rounded-xl px-3 py-2 text-white text-xs sm:text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-sol-cyan/50" />
                    <input type="url" name="telegram" value={formData.telegram} onChange={handleInputChange} placeholder="https://t.me/yourgroup" className="bg-dark-700 border border-white/10 rounded-lg sm:rounded-xl px-3 py-2 text-white text-xs sm:text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-sol-cyan/50" />
                    <input type="url" name="discord" value={formData.discord} onChange={handleInputChange} placeholder="https://discord.gg/xxx" className="bg-dark-700 border border-white/10 rounded-lg sm:rounded-xl px-3 py-2 text-white text-xs sm:text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-sol-cyan/50" />
                </div>
